...
To run this test suite it is needed to specify the core version and channel. The following line shows how to run it:
    ...
    SPREAD_CORE_VERSION=2.36.3 SPREAD_CORE_CHANNEL=stable spread google:tasks/smoke/
...
##### Beta branch on amd64 using testflinger vm
    BRANCH=2.36.3 ~/workspace/snappy-qa-jobs/scripts/run_tf_vm.sh tf_snapd_amd64
...
##### Upgrade from stable on cm3 using testflinger
    BRANCH=2.36.3 ~/workspace/snappy-qa-jobs/scripts/run_tf_device.sh tf_snapd_cm3_refresh

##### Upgrade from stable on amd64 using testflinger vm
    BRANCH=2.36.3 ~/workspace/snappy-qa-jobs/scripts/run_tf_vm.sh tf_snapd_amd64_refresh
...
##### Core revert test on google
    BRANCH=2.36.3 ~/workspace/snappy-qa-jobs/scripts/run_google.sh goo_snapd_amd64_core_revert
...
##### SRU validation execution on google machines
    BRANCH=2.36.3 ~/workspace/snappy-qa-jobs/scripts/run_google_sru.sh goo_snapd_sru_validation
