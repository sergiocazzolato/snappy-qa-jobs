...
export SPREAD_SETUP=${SPREAD_SETUP:-"external:ubuntu-core-18-32:tasks/setup/"}
...
export IMAGE_URL=${IMAGE_URL:-"https://cachio.s3.amazonaws.com/images/pc-i386-18-stable-core_beta/pc.img.xz"}
export USER_ASSERTION_URL=https://cachio.s3.amazonaws.com/images/assertions/auto-import.assert
export VM_PORT=${VM_PORT:-8029}