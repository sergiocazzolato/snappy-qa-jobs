...
export SETUP_2=${SETUP_2:-"echo 'Check nvidia is installed' && lsmod | grep nvidia && echo 'Waiting ...' && sleep 180 && echo 'Check nvidia is installed' && lsmod | grep nvidia && echo 'Finishing setup'"}
